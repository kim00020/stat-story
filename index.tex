...
\chapter{제3강: 외래 관광객 수를 어떻게 셀
것인가}\label{uxc81c3uxac15-uxc678uxb798-uxad00uxad11uxac1d-uxc218uxb97c-uxc5b4uxb5bbuxac8c-uxc140-uxac83uxc778uxac00}
...
\textbf{Robert Fay}와 \textbf{Roger Herriot}이 나섰다
(\textbf{fay1979?}). 그들의 제안은 다음과 같았다.
...
만들어진 합성(synthetic) 추정값이다. 왼쪽 항 \(\hat{Y}_i\)는
서베이로부터 얻은 직접(direct) 추정값이다.
...
의존하므로, 이를 보완하기 위해 직접 추정량과 결합하는 것이 소지역 추정의
핵심이다.
